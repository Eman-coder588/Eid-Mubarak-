...
<head>
    ...
    <style>
        * {
        ...
        @keyframes pulse {
            0% { text-shadow: 0 0 7px #00ffe0, 0 0 20px #00ffe0, 0 0 40px #00ffe0, 0 0 60px #ff1f9d; }
            50% { text-shadow: 0 0 15px #00ffe0, 0 0 30px #00ffe0, 0 0 60px #00ffe0, 0 0 80px #ff1f9d; }
            100% { text-shadow: 0 0 7px #00ffe0, 0 0 20px #00ffe0, 0 0 40px #00ffe0, 0 0 60px #ff1f9d; }
        }
...
<body>
    <div class="scene-container" id="sceneContainer">
        ...
        <svg class="rose" viewBox="0 0 100 200" xmlns="http://www.w3.org/2000/svg">
            <defs>
                ...
                <linearGradient id="stemGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style="stop-color:#b6ff00;stop-opacity:1" />
        ...
        <!-- Final Message -->
        <div class="final-message" id="finalMessage">Happy Eid Ul Azha</div>
    ...
    <script>
        ...
        function createStars() {
            const colors = ['#ffffff', '#5edfff', '#00ffe0', '#b6ff00'];
            for (let i = 0; i < 150; i++) {
        ...
        function createNeonParticles() {
            const colors = ['#5edfff', '#00ffe0', '#00ffe0', '#b6ff00', '#b6ff00'];
        ...
        function createFloatingHearts() {
            const colors = ['#00ffe0', '#00ffe0', '#00ffe0'];
